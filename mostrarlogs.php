...
//echo "<div class='proyectofinal'>";
	//echo "<h4><a href='delete.php?id=" . $row['IDUSUARIO'] . "' class='fa fa-trash-o'style='font-size:18px;color:white; background-color:red;padding:5px'></a></h4>";
	echo "<h1 style='font-size:20px;'>" . $row['NOMBRE'] . "</h1>";
